...
const example = ["banana", "vanilla", "aapple", "orange"];
const remove = ["banana", "apple", "orange"];
...
// 'choclate' ===== 'choclate'
// 'chocklate banan" === 'chocklate'

// Array example
// var example = ["choclate", "banana", "apple", "choclate nut"]
// console.log(example.includes("orange")) // false
// console.log(example.includes('apple")) true

// string exxample
// var string = "apple"
// string.includes('apple')
function filterByWord(Array, string) {
  var newArray = [];

  for (let i = 0; i < Array.length; i++) {
    if (Array[i].toLowerCase().includes(string.toLowerCase())) {
      newArray.push(Array[i]); // pushed to the newArray
    }
  }
...
var string = 'choclate'
 console.log(filterByWord(originalFlavors, string)); // undefined

// console.log("STRING CHECK: ", "Bikesh mahArjan".toLowerCase().includes("bikesh"))
